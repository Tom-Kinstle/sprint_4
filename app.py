...
st.markdown('### **Probably the most dramatic trend we see is the change is sales of cars below 20,000 dollars before and after the 30 days mark.  We can infer that the prices of these vehicles might drop after 30 days which leads to the spike we see in sales.  If pricing of these vehicles is moderated sooner it could help sell these vehicle faster and at a higher price, which would save in costs to maintain them while maximizing profits.** ')